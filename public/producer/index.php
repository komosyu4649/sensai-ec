                ...
                <div class="u-width__sec p-producer-personal__wrapper">
                    ...
                    <div class="u-width__sec-container-full p-producer-personal__container">
                        <div class="p-producer-personal__head">
                            ...
                            <div class="p-producer-personal__head-intro">
                                <p class="c-txt__sec p-producer-personal__head-intro-txt" data-txt="ここに自己紹介的なメッセージが入ります。ここに自己紹介的なメッセージが入ります。">
                                    ここに自己紹介的なメッセージが入ります。 <br>
                                    ここに自己紹介的なメッセージが入ります。
                                </p>
                            </div>
                        </div>
